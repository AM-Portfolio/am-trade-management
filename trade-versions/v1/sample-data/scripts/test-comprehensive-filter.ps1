...
try {
    $response1 = Invoke-RestMethod -Uri $baseUrl -Method Post -Body $comprehensiveFilter -Headers $headers
...
try {
    $response2 = Invoke-RestMethod -Uri $baseUrl -Method Post -Body $highRiskFilter -Headers $headers
...
try {
    $response3 = Invoke-RestMethod -Uri $baseUrl -Method Post -Body $winningFilter -Headers $headers
...
try {
    $response4 = Invoke-RestMethod -Uri $baseUrl -Method Post -Body $optionsFilter -Headers $headers
...
try {
    $allFilters = Invoke-RestMethod -Uri $baseUrl -Method Get -Headers $headers
...
try {
    $defaultFilter = Invoke-RestMethod -Uri "$baseUrl/default" -Method Get -Headers $headers
    if ($defaultFilter) {
...
if ($filterId1) {
    ...
    try {
        $defaultSet = Invoke-RestMethod -Uri "$baseUrl/$filterId1/default" -Method Put -Headers $headers
