...
Invoke-RestMethod -Uri "http://localhost:8050/v1/trades/details/filter?page=0&size=20&sort=profitLoss,desc" -Method Post -ContentType "application/json" -Body $body
```
