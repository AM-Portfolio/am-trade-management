...
@Configuration
@EnableCaching
@ConditionalOnProperty(name = "am.trade.cache.enabled", havingValue = "true", matchIfMissing = true)
public class CacheConfig {
        ...
        public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory, ObjectMapper objectMapper) {
                ...
                cacheConfigurations.put("tradeDetails",
                                defaultConfig.entryTtl(Duration.ofMinutes(tradeDetailsExpiryMinutes)));
                cacheConfigurations.put("portfolioSummary",
                                defaultConfig.entryTtl(Duration.ofMinutes(portfolioSummaryExpiryMinutes)));
