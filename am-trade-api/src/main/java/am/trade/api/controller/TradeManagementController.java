...
public class TradeManagementController {
    ...
    public ResponseEntity<Map<String, List<TradeDetails>>> getTradeDetailsByMonth(
        ...
        Map<String, List<TradeDetails>> tradeDetails = tradeManagementService.getTradeDetailsByMonth(year, month,
                portfolioId);
        return ResponseEntity.ok(tradeDetails);
    }
    ...
    public ResponseEntity<Map<String, List<TradeDetails>>> getTradeDetailsByQuarter(
        ...
        Map<String, List<TradeDetails>> tradeDetails = tradeManagementService.getTradeDetailsByQuarter(year, quarter,
                portfolioId);
        return ResponseEntity.ok(tradeDetails);
    }
    ...
    public ResponseEntity<Map<String, List<TradeDetails>>> getTradeDetailsByDateRange(
        ...
        Map<String, List<TradeDetails>> tradeDetails = tradeManagementService.getTradeDetailsByDateRange(startDate,
                endDate, portfolioId);
        return ResponseEntity.ok(tradeDetails);
    }
