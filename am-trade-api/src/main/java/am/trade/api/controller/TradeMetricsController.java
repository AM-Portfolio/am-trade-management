...
public class TradeMetricsController {
    ...
    public ResponseEntity<List<MetricsResponse>> compareMetrics(
            @Parameter(description = "Portfolio IDs") @RequestParam List<String> portfolioIds,
            @Parameter(description = "Metric types to include") @RequestParam Set<String> metricTypes,
            @Parameter(description = "First period start date") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate firstPeriodStart,
            @Parameter(description = "First period end date") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate firstPeriodEnd,
            @Parameter(description = "Second period start date") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate secondPeriodStart,
            @Parameter(description = "Second period end date") @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate secondPeriodEnd) {
    ...
    public ResponseEntity<Map<String, List<MetricsResponse>>> getMetricsTrends(
            ...
            @Parameter(description = "Time interval (DAY, WEEK, MONTH, QUARTER, YEAR)") @RequestParam String interval) {
